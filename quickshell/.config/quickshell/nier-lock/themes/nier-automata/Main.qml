...
Rectangle {
    ...
    // Clock/date font — matches the date & time font used in nierbar (Theme.fontFamily)
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Image {
                            id: tabIcon
                            source: Qt.resolvedUrl("svgs/" + modelData.name.toLowerCase() + ".svg")
    ...
    Item {
        ...
        Item {
            ...
            Item {
                ...
                function frameUrl(f) {
                    return Qt.resolvedUrl("YoRHa_logo/frame_" + ("000" + f).slice(-4) + ".svg")
                }
