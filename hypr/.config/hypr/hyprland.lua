...
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd(home .. "/.config/quickshell/nier-lock/quickshell-lockscreen/lock.sh"))
...
-- Move focus with Alt + Tab
-- hl.bind("ALT + Tab", hl.dsp.window.cycle_next())
local MAX = 1	-- maximize screen mode number
local FULL = 2	-- fullscreen mode number
hl.bind("ALT + Tab", function()
    local w = hl.get_active_window()
    local s = (w ~= nil) and w.fullscreen or 0
    hl.dispatch(hl.dsp.window.cycle_next())
    --[[ in hyprland >=0.55, we don't need this anymore
    if s == FULL then
